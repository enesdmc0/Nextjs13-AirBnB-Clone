...
import CountrySelect, {CountrySelectValue} from "@/components/inputs/CategoryInput/CountrySelect";
    ...
    if (step === STEPS.DATE) {
        bodyContent = (
            <div className="flex flex-col gap-8">
                ...
                <Calendar onChange={value => setDateRange(value.section)} value={dateRange} />
            </div>
        )
    }
