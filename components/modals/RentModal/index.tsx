...
import CountrySelect from "@/components/inputs/CategoryInput/CountrySelect";
    ...
    if (step === STEPS.PRICE) {
        bodyContent = (
            <div className="flex flex-col gap-8">
                ...
                <Input id="price" label="Price" formatPrice type="number" register={register} errors={errors} disabled={isLoading} required />
            </div>
        )
    }
